...
class AvatarWidget(QLabel):
    ...
    def set_character_folder(self, folder):
        ...
        self.load_avatar("neutral")  # Load the neutral avatar for the character once the folder is set
    ...
    def load_avatar(self, emotion):
        ...
        base_path = os.path.join(os.path.dirname(__file__), 'sprites', self.character_folder)
